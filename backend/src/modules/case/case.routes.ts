...
import { getMyCases, getAllCases, getCaseById, assignCase, completeInvestigation, getCaseCopilotBrief } from './case.controller';
 ...
 * AI Copilot brief for a case - all authenticated users with access
 */
router.get('/:caseId/copilot-brief', authenticate, allowAll, getCaseCopilotBrief);
